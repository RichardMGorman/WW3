...
MODULE W3PRO2MD
  ...
  !/    01-Jul-2026 : Adding quadtree subroutines         ( version X.XX )
  !/                  (R. Gorman, NIWA)
  !/
  ...
  !                               obstruction.
  !      QT1DUNO2  Subr. W3PROQMD UNO2 scheme for quadtree grid.
  !     ----------------------------------------------------------------
  !
  !  5. Remarks :
  !
...
9042 FORMAT (1X,60I3)
  ...
  SUBROUTINE W3XYQ2 ( ISP, DTG, FIELD, VGX, VGY )
    ...
    !/                  +-----------------------------------+
    !/
    !/    17-Oct-2017 : Origination, based on W3XYQ1 and W3PSMC (J-G. Li)
    !/    01-Jul-2026 : 
    !/
    !  1. Purpose :
    !
    ...
    !  2. Method :
    !
    !     Second order UNO2 scheme with flux formulation, including
    !     diffusion and sub-grid obstruction
    !
    !  3. Parameters :
    !
    !     Parameter list
    ...
    !
#ifdef W3_MGP
      CXTOT(ISEA) = CXTOT(ISEA) - VGX/CLATS(ISEA)
      CXTOT(ISEA) = CYTOT(ISEA) - VGY
#endif
#ifdef W3_T1
      WRITE (NDST,9021) ISEA, ISEA, CQ(ISEA), CXTOT(ISEA), CYTOT(ISEA)
#endif
    END DO
    !
    ...
    !
#ifdef W3_T
9000 FORMAT (' TEST W3XYQ2 : NTLOC :',I4)
9001 FORMAT (' TEST W3XYQ2 : ISP, ITH, IK :',I8,2I4)
9002 FORMAT (' TEST W3XYQ2 : LVLT, NTSUB :',2I4)
#endif
    !
#ifdef W3_T1
9010 FORMAT (' TEST W3XYQ2 : ITLOC =',I3)
9020 FORMAT (' TEST W3XYQ2 : ISEA, IXY, FIELD, VCX, VCY')
